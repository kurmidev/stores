    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-body">
                ...
                <?= $form->field($model, 'action_type', ['options' => ['class' => "form-group"]])->begin(); ?>
                <?= Html::activeLabel($model, 'action_type', ['class' => 'col-lg-12 col-sm-12 col-xs-12 control-label']) ?>
                <div class="col-lg-6 col-sm-6 col-xs-6">
                    <?= Html::activeDropDownList($model, 'action_type', C::PAYMENT_ACTION_LABELS, ['class' => 'form-control', "prompt" => "Select One"]) ?>
                    <?= Html::error($model, 'action_type', ['class' => 'error help-block']) ?>
                </div>
                <?= $form->field($model, 'action_type')->end() ?>
